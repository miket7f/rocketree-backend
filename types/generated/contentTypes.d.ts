...
export interface ApiLevelLevel extends Schema.CollectionType {
  ...
  attributes: {
    ...
    topic: Attribute.Relation<
      ...
      'api::topic.topic'
    >;
    predecessor: Attribute.Relation<
      'api::level.level',
      'oneToOne',
      'api::level.level'
    >;
    level_completions: Attribute.Relation<
      'api::level.level',
      'oneToMany',
      'api::level-completion.level-completion'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiLevelCompletionLevelCompletion
  ...
  attributes: {
    completed: Attribute.DateTime & Attribute.Required;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::level-completion.level-completion': ApiLevelCompletionLevelCompletion;
